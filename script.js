...
// Função para enviar os dados do cadastro para a planilha
function enviarParaPlanilhaCadastro(cadastro) {
  const scriptURL = 'https://script.google.com/macros/s/AKfycbzUbxMpUbD4z1NbccuJ3G7ZsCwCAieGr-DdbvRpGe0X-F5nyLLJ-MwWwYt1kLvUbRvnIQ/exec'; // URL do Apps Script
...
function carregarProdutos() {
  const sheetId = "1gjUkfzz0_0XWVXkMA4Bn0jC_RKWYuiCT0rSQ5KbGVHA"; // ID da planilha
  const apiKey = "AIzaSyD9RaM6QqFsE9I6egeRFXaq09qivzNieMk"; // Chave da API do Google
      ...
      produtos.forEach(produto => {
        ...
        card.innerHTML = `
          ...
          <div class="card-conteudo">
            ...
            <button class="btn-adicionar" data-nome="${nome}" data-preco="${preco}">Adicionar ao carrinho</button>
          </div>
        `;
